    	...
    	<div class="section group">
    		...
    		?>
				...
				<div class="desc span_3_of_2">
					...
					<div class="price">
						<p>Chủ đề: <span><?php echo $result['catName']?></span></p>
						<p>Tác giả: <span><?php echo $result['auName']?></span></p>
						<p>Giá bán: <span><?php echo $fm->fomat_currency($result['price'])." VND"?></span></p>
					</div>
				<div class="add-cart">
